          ...
          <div className="relative hidden lg:block">
            <div className="relative h-[600px] w-full">
              ...
              <div className="absolute top-4 left-1/2 transform -translate-x-1/2">
                <div className="bg-zinc-900 rounded-lg shadow-lg w-96 border border-zinc-700">
                  {/* Header */}
                  <div className="flex items-center justify-between p-4 border-b border-zinc-700">
                    <h3 className="text-sm font-medium text-white">Create Post</h3>
                  ...
                  <div className="p-4 space-y-4">
                    <textarea 
                      className="w-full h-20 text-sm text-white placeholder-zinc-400 resize-none border-none outline-none bg-transparent"
                    ...
                    <div className="flex items-center space-x-3 pt-2">
                      <span className="text-xs text-zinc-400 font-medium">Post to:</span>
                      <div className="flex space-x-2">
                        <div className="flex items-center space-x-1 bg-blue-900/20 px-2 py-1 rounded-md">
                          <div className="w-4 h-4 bg-blue-500 rounded-sm"></div>
                          <span className="text-xs text-blue-400">LinkedIn</span>
                        </div>
                        <div className="flex items-center space-x-1 bg-zinc-800 px-2 py-1 rounded-md">
                          <div className="w-4 h-4 bg-gray-800 rounded-sm"></div>
                          <span className="text-xs text-zinc-300">Twitter</span>
                        </div>
                        <div className="flex items-center space-x-1 bg-purple-900/20 px-2 py-1 rounded-md">
              ...
              <div className="absolute bottom-0 left-0 right-0">
                <div className="relative h-80">
                  ...
                  <div className="absolute top-0 left-4 transform rotate-1 z-40">
                    <div className="w-80 h-44 bg-zinc-900 rounded-xl shadow-2xl border border-zinc-700 overflow-hidden">
                      <div className="p-5 h-full flex flex-col">
                        ...
                        <div className="flex items-center justify-between mb-4">
                          <div className="flex items-center space-x-3">
                            ...
                            <div>
                              <span className="text-sm font-semibold text-white">LinkedIn Analytics</span>
                        ...
                        <div className="grid grid-cols-3 gap-4 mb-4">
                          ...
                          <div className="text-center border-l border-r border-zinc-700 px-2">
                            <div className="text-2xl font-bold text-white">4.2%</div>
                            <div className="text-xs text-zinc-400">CTR</div>
                          </div>
                          <div className="text-center">
                            <div className="text-2xl font-bold text-white">167</div>
                            <div className="text-xs text-zinc-400">Clicks</div>
                          </div>
                        </div>
                        
                        {/* Performance Chart */}
                        <div className="flex items-end justify-between h-8 bg-gradient-to-t from-blue-900/20 to-transparent rounded px-2">
                  ...
                  <div className="absolute top-8 right-0 transform -rotate-1 z-30">
                    <div className="w-76 h-40 bg-zinc-900 rounded-xl shadow-xl border border-zinc-700 overflow-hidden">
                      <div className="p-4 h-full flex flex-col">
                        ...
                        <div className="flex items-center justify-between mb-3">
                          <div className="flex items-center space-x-2">
                            ...
                            <div>
                              ...
                              <div className="text-xs text-zinc-400">Stories & Posts</div>
                            </div>
                          </div>
                        ...
                        {/* Mini Chart */}
                        <div className="flex items-end space-x-1.5 h-6 bg-gradient-to-t from-purple-900/20 to-transparent rounded px-1">
                  ...
                  <div className="absolute bottom-4 left-8 transform rotate-1 z-20">
                    <div className="w-72 h-36 bg-zinc-900 rounded-xl shadow-xl border border-zinc-700 overflow-hidden">
                      <div className="p-4 h-full flex flex-col">
                        {/* Header */}
                        <div className="flex items-center justify-between mb-3">
                          <div className="flex items-center space-x-2">
                            ...
                            <div>
                              ...
                              <div className="text-xs text-zinc-400">Tweets & Replies</div>
                            </div>
                          </div>
                        ...
                        <div className="grid grid-cols-3 gap-3 mb-3">
                          ...
                          <div className="text-center">
                            ...
                            <div className="text-xs text-zinc-400">Retweets</div>
                          </div>
                          <div className="text-center">
                        ...
                        <div className="flex items-center justify-between bg-emerald-900/20 rounded-lg px-3 py-2">
                          <span className="text-xs text-emerald-600">Engagement Rate</span>
                          <div className="flex items-center space-x-2">
                            <div className="w-16 bg-emerald-200 rounded-full h-1">
                              <div className="bg-emerald-600 h-1 rounded-full w-3/4"></div>
                            </div>
                            <span className="text-xs font-medium text-emerald-700">6.8%</span>
                          </div>
                        </div>
                      </div>
                    </div>
                  ...
                  <div className="absolute bottom-0 right-8 transform -rotate-2 z-10">
                    <div className="w-64 h-32 bg-zinc-900 rounded-xl shadow-lg border border-zinc-700 overflow-hidden">
                      <div className="p-3 h-full flex flex-col">
                        ...
                        <div className="flex items-center justify-between mb-2">
                          ...
                          <span className="text-xs text-orange-700 bg-orange-50 px-1.5 py-0.5 rounded font-medium">+9.1%</span>
                        </div>
                        
                        {/* Metrics */}
                        <div className="grid grid-cols-2 gap-3 mb-2">
                          <div>
                            <div className="text-lg font-bold text-white">5.8K</div>
                            <div className="text-xs text-zinc-400">Page Views</div>
                          </div>
                          <div>
                            <div className="text-lg font-bold text-white">234</div>
                            <div className="text-xs text-zinc-400">Page Likes</div>
                          </div>
                        </div>
                        
                        {/* Simple chart */}
                        <div className="flex items-end space-x-1 h-4">
                          <div className="bg-orange-400 w-1 h-2 rounded-t"></div>
                          <div className="bg-orange-500 w-1 h-3 rounded-t"></div>
                          <div className="bg-orange-600 w-1 h-4 rounded-t"></div>
                          <div className="bg-orange-500 w-1 h-3 rounded-t"></div>
                          <div className="bg-orange-400 w-1 h-2 rounded-t"></div>
                        </div>
                      </div>
