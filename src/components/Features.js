        ...
        <section id="features" className="relative bg-black">
            ...
            <div className="max-w-7xl mx-auto px-6 py-20">
                ...
                <div className="relative">
                    ...
                    <div className="relative grid md:grid-cols-2 lg:grid-cols-4 gap-6 p-8 bg-zinc-900/30 backdrop-blur-sm rounded-3xl border border-zinc-800/50">
                        {[
                            {
                                name: 'Twitter',
                            ...
                            <div key={i} className={`group relative bg-gradient-to-br ${platform.gradient} ${platform.hoverGradient} rounded-2xl p-6 transition-all duration-500 transform hover:scale-105 hover:shadow-2xl`}>
                                {/* Platform icon */}
                                <div className="flex items-center justify-center w-16 h-16 bg-white/10 backdrop-blur-sm rounded-xl mb-4 group-hover:bg-white/20 transition-all duration-300">
                                    {platform.icon}
                                </div>
