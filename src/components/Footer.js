        ...
        <div className="grid md:grid-cols-4 gap-12">
          ...
          <div className="md:col-span-1">
            ...
            <div className="flex space-x-3">
              <a href="#" className="w-9 h-9 bg-gray-100 rounded-full flex items-center justify-center text-gray-500 hover:text-gray-700 hover:bg-gray-200 transition-colors duration-200">
                ...
                {section.links.map((link) => (
                  <li key={link}>
                    {link === 'About' ? (
                      ...
                      <Link to="/about#contact" className="text-gray-600 hover:text-gray-900 transition-colors duration-200">
                        {link}
                      </Link>
                    ) : (
