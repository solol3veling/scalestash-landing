      ...
      <div className="max-w-6xl mx-auto px-6 py-16">
        <div className="grid md:grid-cols-4 gap-12">
          ...
          <div className="md:col-span-1">
            ...
            <div className="flex space-x-3">
              <a href="https://twitter.com/scalestash" target="_blank" rel="noopener noreferrer" className="w-9 h-9 bg-zinc-800 rounded-full flex items-center justify-center text-zinc-400 hover:text-white hover:bg-zinc-700 transition-colors duration-200" aria-label="Follow us on Twitter">
                <svg className="w-4 h-4" fill="currentColor" viewBox="0 0 24 24">
                  <path d="M8.29 20.251c7.547 0 11.675-6.253 11.675-11.675 0-.178 0-.355-.012-.53A8.348 8.348 0 0022 5.92a8.19 8.19 0 01-2.357.646 4.118 4.118 0 001.804-2.27 8.224 8.224 0 01-2.605.996 4.107 4.107 0 00-6.993 3.743 11.65 11.65 0 01-8.457-4.287 4.106 4.106 0 001.27 5.477A4.072 4.072 0 012.8 9.713v.052a4.105 4.105 0 003.292 4.022 4.095 4.095 0 01-1.853.07 4.108 4.108 0 003.834 2.85A8.233 8.233 0 012 18.407a11.616 11.616 0 006.29 1.84"/>
                </svg>
              </a>
              <a href="https://linkedin.com/company/scalestash" target="_blank" rel="noopener noreferrer" className="w-9 h-9 bg-zinc-800 rounded-full flex items-center justify-center text-zinc-400 hover:text-white hover:bg-zinc-700 transition-colors duration-200" aria-label="Follow us on LinkedIn">
                <svg className="w-4 h-4" fill="currentColor" viewBox="0 0 24 24">
                ...
                {section.links.map((link) => (
                  <li key={link}>
                    {link === 'About' ? (
                      ...
                      <button className="text-zinc-400 hover:text-white transition-colors duration-200 text-left">
                        {link}
                      </button>
                    )}
                  </li>
        ...
        <div className="mt-16 pt-8 border-t border-zinc-800 flex flex-col md:flex-row justify-between items-center space-y-4 md:space-y-0">
          ...
          <div className="flex space-x-6 text-sm">
            <button className="text-zinc-500 hover:text-zinc-300 transition-colors duration-200">
              Privacy
            </button>
            <button className="text-zinc-500 hover:text-zinc-300 transition-colors duration-200">
              Terms
